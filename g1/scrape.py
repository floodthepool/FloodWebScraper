...
def get_guitar(driver1, link, soup):
    manufacturer = ['fender' , 'squier' , 'gibson' , 'suhr' , 'paul reed smith' , 'ibanez' , 'epiphone' , 'charvel' , 'strandberg' , 'kiesel' , 'nash', 'reverend' , 'rickenbacker' , 'peavey']

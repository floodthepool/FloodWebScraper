...
def check_words():
    ...
    words_to_check = ['contemporary stratocaster' , 'contemporary' , 'mira x', 'starla x', 'shell pink' , 'king of tone' , 'allen amplification' , 'oldfield' , 'analogman' , 'bass vi' , 'keeley mod' , 'JHS mod' , 'grandma hannon'
                                                                                                                                                                                                                     '']
    results = ''
    ...
    print(results)
    if results != '':
        send_mail.send_email('Guitar Hit', str(results))
    driver1.close()

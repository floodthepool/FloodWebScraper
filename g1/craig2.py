...
def check_craig():
    ...
    url = 'https://raleigh.craigslist.org/d/musical-instruments-by-owner/search/msg?sort=date&query=-cymbal%20-horns%20-violin%20-drum%20-flute%20-piano%20-horn%20-keybord%20-ukelele%20-saxophone%20-trumpet%20-alto%20-sax'
    ...
    print(results)
    if results != '':
        send_mail.send_email('Found new items RALEIGH ', str(results))
    driver1.close
